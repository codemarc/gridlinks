...
export default function Settings({ themeProps }) {
   const { name, ls, darkMode, setDarkMode, gridSet, setGridSet } = themeProps;
   ...
   return (
      <Box sx={box1}>
         ...
         {value === 0 && (
            <Box sx={{ marginLeft:"22px", height: "224px", fontSize: "10pt", padding: "8px" }}>
               {/* Appearance settings or other content for the "Appearance" tab */}
               Appearance:
               <Switch
